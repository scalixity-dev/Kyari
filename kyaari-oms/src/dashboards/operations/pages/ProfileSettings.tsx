...
export default function ProfileSettings() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 bg-[var(--color-happyplant-bg)] min-h-[calc(100vh-4rem)] font-sans w-full overflow-x-hidden">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`py-2 px-1 border-b-2 font-medium text-xs sm:text-sm flex items-center gap-2 transition-colors whitespace-nowrap min-h-[44px] ${
                    activeTab === tab.id
      ...
      {/* Profile Tab */}
      {activeTab === 'profile' && (
        <div className="bg-white rounded-xl shadow-md border border-white/20 p-4 sm:p-6 md:p-8">
