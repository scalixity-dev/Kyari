    ...
    <div className="p-3 sm:p-4 md:p-6 font-sans text-primary" style={{ background: 'transparent' }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-5">
        <div className="rounded-2xl p-4 shadow-md bg-white">
          ...
          <div className="text-2xl sm:text-3xl font-semibold text-secondary mt-1">{openCount}</div>
        </div>
        <div className="rounded-2xl p-4 shadow-md bg-red-50">
          <div className="text-sm text-gray-700">SLA Breaches</div>
          <div className="text-2xl sm:text-3xl font-semibold text-red-600 mt-1">{slaBreaches}</div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-3 items-stretch sm:items-center mb-4 bg-white border border-secondary/20 rounded-xl p-3">
        <select value={filterVendor} onChange={e => setFilterVendor(e.target.value)} className="px-3 py-2 min-h-[44px] rounded-xl border border-gray-300 w-full sm:w-auto">
        ...
        <input placeholder="Search ticket/vendor" value={search} onChange={e => setSearch(e.target.value)} className="px-3 py-2 min-h-[44px] rounded-xl border border-gray-300 w-full sm:flex-1 sm:min-w-[200px]" />
            ...
            <div key={t.id} className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <div className="text-sm text-gray-600 mt-0.5">{t.vendor}</div>
                </div>
